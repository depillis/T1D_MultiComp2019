% This code will first call the ParametersLHS.m script to access the
% parameters from the multicompartmental model, then set the initial
% conditions for the ODE's, and set up the ODE's from the
% multicompartmental model

% Amber Nguyen, code adapted from An Do
function dy = ODE_efast(t,y,fMat,fMt, wave)

% Call ParametersLHS.m script
ParametersLHS;
